...
public class SSAORendererFeature : ScriptableRendererFeature
{
    class CustomRenderPass : ScriptableRenderPass
    {
        ...
        private void UpdateUniforms(RenderingData renderingData)
        {
    ...
    public RenderPassEvent renderQueue = RenderPassEvent.BeforeRenderingPostProcessing;
    ...
    */
    ...
    public override void AddRenderPasses(ScriptableRenderer renderer, ref RenderingData renderingData)
    {
        ...
        m_ScriptablePass.depthTex = renderer.cameraDepth;
